...
l gew    - pprint a scala val in the ScalaJsApp browser console!
...
### sbt Reloader
see ~/Documents/Notes/vim-cheat-sheet.md‖/###ˍsbt-pri
...
ll s; - (hardly used) strip semicolon .. and then af/ap/,j
