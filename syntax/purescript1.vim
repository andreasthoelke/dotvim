...
" seems I want to see this when editing the type vars
" syn match hsForall "forall.*\.\s" conceal containedin=purescriptFunctionDeclStart

syn match hsTopLevelBind "\v^\s*[a-z](\w|\'){-}\ze\s.{-}\::\_s" containedin=purescriptFunctionDeclStart
syn match hsTopLevelBind "\v^[a-z]\w{-}\ze\s.{-}\=\_s"
syn match hsTopLevelBind "\v^\s*\zs[a-z](\w|\')\w{-}\ze\s.{-}\=\_s"
...
let b:current_syntax = "purescript1"
