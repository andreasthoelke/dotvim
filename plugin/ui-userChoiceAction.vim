...
" Note: that all code that aims to use the selected value/effect needs to run in the continuation function. (there should be no
...
func! TestUserChoice1 ( choosenObj )
  echoe 'The payload chosen is: ' . a:choosenObj.otherData
endfunc
