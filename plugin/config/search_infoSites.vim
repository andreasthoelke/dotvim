...
nnoremap <silent><leader>gso :call UserChoiceAction( 'Run query on site', {'identifier': HsCursorKeyword()},       g:searchSites, 'RunSearch', [{'browser':'default'}] )<cr>
nnoremap <silent><leader>gsO :call UserChoiceAction( 'Run query on site', {'identifier': GetInputStr('Search term: ')}, g:searchSites, 'RunSearch', [{'browser':'default'}] )<cr>
vnoremap <silent><leader>gso :<c-u>call UserChoiceAction( 'Run query on site', {'identifier': GetVisSel()},        g:searchSites, 'RunSearch', [{'browser':'default'}] )<cr>
vnoremap <silent>gsO :<c-u>call UserChoiceAction( 'Run query on site', {'identifier': GetInputStr('Search term: ')},        g:searchSites, 'RunSearch', [{'browser':'default'}] )<cr>
...
func! RunSearch ( searchParams, browser, siteProps )
  ...
  if has_key( a:siteProps, 'baseUrl' )
    ...
    call LaunchChrome( a:siteProps.baseUrl . queryStr )
