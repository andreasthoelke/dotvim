...
function CompareWithClipboard()
    ...
    -- Create a new buffer for the clipboard content
    ...
    -- Open a new window and set it to the clipboard buffer
    vim.cmd('vsplit')
    ...
    -- Set up an autocommand to clean up when leaving diff mode
    vim.cmd([[
        augroup CleanupDiffBuffer
        autocmd!
        autocmd WinClosed ]] .. clipboard_win .. [[ lua CleanupDiffBuffer(]] .. clipboard_buf .. [[)
        augroup END
    ]])
end

function CleanupDiffBuffer(buf)
    ...
    vim.cmd('augroup CleanupDiffBuffer')
    vim.cmd('autocmd!')
    vim.cmd('augroup END')
end
