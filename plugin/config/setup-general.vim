...
" not sure if either one of these versions helps to prevent the insert cursor turning white after 'A' (insert end of the line)
" unmap A
" nnoremap <silent> A A<esc>:mode<cr>a
nnoremap <silent> A $:mode<cr>a
...
" ─   Hop                                               ──
" see ~/.config/nvim/plugin/config/hop.lua
