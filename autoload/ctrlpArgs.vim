...
" From: https://github.com/kshenoy/vim-ctrlp-args/blob/master/autoload/ctrlp/args.vim
...
function! ctrlpArgs#init()                                                                                       " {{{1
  return s:get_args()
endfunction

func! ctrlpArgs#accept(mode, str)                                                                            " {{{1
  ...
  " echoe "mode: " . a:mode . ", str: " . a:str

  if a:mode == 'h'
    call Arglist_toggleItems( [a:str] )
    call ctrlp#exit()
    call ctrlp#init( ctrlpArgs#id() )
  else
